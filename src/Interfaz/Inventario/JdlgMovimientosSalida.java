 ...
 * @author JoBren8
 */
public class JdlgMovimientosSalida extends javax.swing.JDialog {
    ...
    public JdlgMovimientosSalida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jbtnBuscarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBuscarProductoActionPerformed
        JdlgProductosBuscar ventanaBuscarProducto = new JdlgProductosBuscar(this, true, 1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdlgMovimientosSalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                JdlgMovimientosSalida dialog = new JdlgMovimientosSalida(new javax.swing.JFrame(), true);
