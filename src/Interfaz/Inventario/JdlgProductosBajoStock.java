 ...
 * @author Jonathan
 */
public class JdlgProductosBajoStock extends javax.swing.JDialog {

    //Variables
    NoEditableTableModel modeloProductos;
    
    public JdlgProductosBajoStock(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdlgProductosBajoStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                JdlgProductosBajoStock dialog = new JdlgProductosBajoStock(new javax.swing.JFrame(), true);
