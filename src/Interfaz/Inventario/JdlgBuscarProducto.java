 ...
 * @author JoBren8
 */
public class JdlgBuscarProducto extends javax.swing.JDialog {

    //Variables
    Producto producto = new Producto();
    JdlgMovimientoEntrada padreEntrada;
    JdlgMovimientoSalida padreSalida;
    int tipoMovimiento = 0;

    public JdlgBuscarProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public JdlgBuscarProducto(javax.swing.JDialog parent, boolean modal, int movimiento) {
        super(parent, modal);
        initComponents();
        ...
        switch (tipoMovimiento) {
            case 0:
                this.padreEntrada = (JdlgMovimientoEntrada) parent;
                break;
            case 1:
                this.padreSalida = (JdlgMovimientoSalida) parent;
                break;
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdlgBuscarProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                JdlgBuscarProducto dialog = new JdlgBuscarProducto(new javax.swing.JFrame(), true);
