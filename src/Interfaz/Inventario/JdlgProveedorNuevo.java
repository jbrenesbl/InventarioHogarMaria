 ...
 * @author JoBren8
 */
public class JdlgProveedorNuevo extends javax.swing.JDialog {

    //Variables
    Proveedor proveedor = new Proveedor();

    public JdlgProveedorNuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public JdlgProveedorNuevo(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null); //Centrar Ventana
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdlgProveedorNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                JdlgProveedorNuevo dialog = new JdlgProveedorNuevo(new javax.swing.JFrame(), true);
