 ...
 * @author jobren8
 */
public class JdlgMovimientosAsignarCheque extends javax.swing.JDialog {

    //Variables
    NoEditableTableModel modeloMovimientos;
    boolean confirmarPermiso = false; //Nos indicara si la accion a ejecutar tiene permiso

    public JdlgMovimientosAsignarCheque(java.awt.Frame parent, boolean modal, String encargado) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdlgMovimientosAsignarCheque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                JdlgMovimientosAsignarCheque dialog = new JdlgMovimientosAsignarCheque(new javax.swing.JFrame(), true, "");
