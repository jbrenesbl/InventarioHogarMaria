 ...
 * @author JoBren8
 */
public class JdlgProductosNuevo extends javax.swing.JDialog {

    //Variables
    Producto producto = new Producto();
    boolean comboboxEditable = false;

    public JdlgProductosNuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public JdlgProductosNuevo(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null); //Centrar Ventana
        inicializarDatos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdlgProductosNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                JdlgProductosNuevo dialog = new JdlgProductosNuevo(new javax.swing.JFrame(), true);
