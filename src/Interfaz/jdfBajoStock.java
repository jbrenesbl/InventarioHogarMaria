 ...
 * @author Jonathan
 */
public class jdfBajoStock extends javax.swing.JDialog {

    /**
     * Creates new form jdfBajoStock
     */
    public jdfBajoStock(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdfBajoStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jdfBajoStock dialog = new jdfBajoStock(new javax.swing.JFrame(), true);
