 ...
 * @author JoBren8
 */
public class jdfConsultarProducto extends javax.swing.JDialog {

    /**
     * Creates new form jdfConsultarProducto
     */
    public jdfConsultarProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdfConsultarProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jdfConsultarProducto dialog = new jdfConsultarProducto(new javax.swing.JFrame(), true);
